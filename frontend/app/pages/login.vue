		...
		<div class="auth-split-layout">
			...
			<div class="auth-form-side">
				<div class="form-wrapper">
					...
					<p class="auth-subtitle" v-if="isLogin">
					...
					<form class="auth-form" @submit.prevent="handleSubmit">
						<div class="form-group">
							...
							<input
								...
								v-model="form.email"
								type="email"
								placeholder="pikachu@thi-tran-pallet.vn"
								required
							/>
						</div>
					...
					<div class="social-logins">
						...
						<button type="button" class="social-btn facebook-btn">
							...
							>
								<path
									d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.99 3.66 9.13 8.44 9.88v-6.99h-2.54V12h2.54V9.8c0-2.51 1.49-3.89 3.78-3.89 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.77l-.44 2.89h-2.33v6.99C18.34 21.13 22 16.99 22 12z"
									fill="#1877F2"
								/>
							</svg>
							<span>Facebook</span>
