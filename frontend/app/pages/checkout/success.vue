...
.success-card {
  ...
  text-align: center;
  box-shadow: 0 20px 50px rgba(0, 49, 83, 0.1);
...
.success-card::before {
  ...
  height: 6px;
  background: linear-gradient(90deg, var(--color-prussian-blue) 0%, var(--color-cypress-green) 50%, var(--color-sunflower-yellow) 100%);
}
...
.success-emblem {
  ...
  box-shadow: 0 4px 15px rgba(184, 130, 27, 0.4);
}
.success-emblem svg {
  width: 36px;
  height: 36px;
