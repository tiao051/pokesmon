<script setup>
	...
	const {
		...
		error: detailError,
	} = await useAsyncData(`product-${route.params.slug}`, () =>
	...
	const placeholderImage =
		"https://placehold.co/400x500/003153/FFC512?text=151+Booster+Box";
	const showRealImage = ref(true);
	const toggleImage = () => {
		showRealImage.value = !showRealImage.value;
	};
...
<template>
	...
	<main v-else-if="product" class="detail-page">
